...
public class Xray extends Application {
	...
	private final static int VERS1 = 1;
	private final static int VERS2 = 1;
	private final static int VERS3 = 0;
	public static final String VERSION = VERS1 + "." + VERS2 + "." + VERS3;
	private static final String APP_TITLE_VERSION = APP_TITLE + " " + VERSION;
	
	public static final String DEVELOPER = "Christian" + " " + "\"PilzHere\"" + " " + "Pilz";
	public static final String DEVELOPER_WEBSITE = "http://www.christianpilz.com/";
	public static final String DEVELOPER_MAIL = "contact@christianpilz.com";
